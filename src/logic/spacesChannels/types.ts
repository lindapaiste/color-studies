 ...
 */
export type TupleShared<
  CS extends ColorSpaceName,
  T = number
> = CS extends "cmky" ? Required<BasicTuple<T>> : BasicTuple<T>;
...
export type _ChannelMax<T extends ChannelName> = T extends VariableMaxChannel
  ? _VariableMax
  : number;
...
export type ChannelTuple<CS extends ColorSpaceName> = Tuple<
  ChannelCount<CS>,
  ChannelName
>;
