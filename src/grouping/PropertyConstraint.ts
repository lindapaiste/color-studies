...
export class PropertyConstraint {
     ...
     */
    getMatchError = (color: I_ColorAdapter, allowance: number = 0): string | false => {
 ...
 */
export const getAllowance = (channel: ChannelAdapter, fuzzPercent: number, color?: I_ColorAdapter) => {
    return channel.range * fuzzPercent //is is divided by 100 or not?
}
