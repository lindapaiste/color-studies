 ...
 */
const padAmounts = ({width, toolPadding}: { width: number, toolPadding: number | string | Padding }): Record<Sides, number> => {
    ...
    const handleValue = (value: string | number | undefined): number => {
        return typeof value === "number" ? value :
            typeof value === "string" ? Math.round(width * parseFloat(value) / 100)
                : 0;
    }
