...
import { Distribution, I_BinaryClassifier, I_Boundary } from "./types";
...
export class BoundaryModel implements I_Boundary, I_BinaryClassifier<number> {
  ...
  predict = (value: number): boolean => {
    return value > this.cutoff ? this.isGreater : !this.isGreater;
  };
}
