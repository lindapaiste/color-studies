...
import {I_GetGroupedResults, I_Predicted, I_ResultGroups, I_Testable, I_TestInput, ResultType} from "./types";
...
export class ModelTest<T, S extends I_Predicted> implements I_ResultGroups<Res<T, S>[]>, I_GetGroupedResults<Res<T, S>> {
