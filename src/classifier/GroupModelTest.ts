import {GroupColorClassifier, I_GetGroupedResults, I_Predicted, ResultType} from "./types";
...
export class GroupModelTest<R extends I_Predicted> implements I_GetGroupedResults<Res<I_ColorAdapter,R>>{
    ...
    public test = ( count: number ): void => {
        ...
        this.results.testMany(data.map(obj => ({
            ...obj,
    ...
    getResults = (type: ResultType | undefined): Res<I_ColorAdapter, R>[] => {
        return this.results.getResults(type);
    }
