import { I_Perceptron, DataPoint, Stage } from "./types";
...
export class Trainer {
    public readonly model: I_Perceptron;
    ...
    constructor(
        ...
        while (!this.isTrained && this.stages.length < maxEpochs) {
            ...
            this.isTrained = this._epoch(trainingSet);
     ...
     */
    private _epoch(trainingSet: DataPoint[]): boolean {
        /**
        ...
        return this._isSuccess(stage);
    }

    private _isSuccess(stage: Stage): boolean {
