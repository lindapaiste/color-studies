...
import {getStandardTransform, TransformPair} from "./transforms";

export type ModelTransformArray<CS extends ColorSpaceName> = ChannelCountTuple<CS, boolean | TransformPair>;
export type ModelTransformProp<CS extends ColorSpaceName> = ModelTransformArray<CS> | true | false;
...
export class ModelTransform<CS extends ColorSpaceName> {
    ...
    constructor(props: Props<CS>) {
        ...
        transforms = tupleMap(transforms, (v, i) => v === true ? getStandardTransform(this.model.channels[i], this.normalized) : v);
        this.transforms = transforms as ChannelCountTuple<CS, false | TransformPair>;
    }
     ...
     */
    public apply(tuple: TupleClass<CS>, direction: keyof TransformPair): TupleClass<CS> {
